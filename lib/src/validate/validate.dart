...
abstract class Validate {
  ...
  */
  ...
  static void isAlphaNumeric(String input,
      [String message = DEFAULT_MATCHES_PATTERN_EX]) {
    matchesPattern(input, RegExp(PATTERN_ALPHANUMERIC), message);
  }

  static void isHex(String input,
      [String message = DEFAULT_MATCHES_PATTERN_EX]) {
    matchesPattern(input, RegExp(PATTERN_HEX), message);
  }

  static void isUUID(String input,
      [String message = DEFAULT_MATCHES_PATTERN_EX]) {
    matchesPattern(input, RegExp(PATTERN_UUID), message);
  }
